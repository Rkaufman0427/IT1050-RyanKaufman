...
namespace Lab2
{
    class Addition
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("B. What is the difference between an integer type variable and a double / floating-point variable?, The Difference is that Integer Type are whole number and Double/Floating-point variables are decimals.");
            ...
            Console.WriteLine("E. What is the difference between a class and an object?, A class is a template for objects.  How many instances of a class can we create?, There is no limit you can create as many as you want.");
        }
    }
}
